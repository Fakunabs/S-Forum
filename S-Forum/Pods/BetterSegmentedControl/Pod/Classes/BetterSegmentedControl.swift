...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    private lazy var defaultSegments: [BetterSegmentedControlSegment] = {
        return [LabelSegment(text: "Firs"), LabelSegment(text: "Second")]
    }()
    ...
    required public init?(coder aDecoder: NSCoder) {
        self.index = 0
        self.segments = [LabelSegment(text: "Fi", icon: UIImage(named: "home-popular-icon")), LabelSegment(text: "Second", icon: UIImage(named: "selected-tab-icon"))]
        super.init(coder: aDecoder)
        completeInit()
    }
