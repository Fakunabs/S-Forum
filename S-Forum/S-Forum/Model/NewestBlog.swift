...
struct NewestBlogResponse: Codable {
    let docs: [NewestBlog]
...
struct UserID: Codable {
    ...
    let createdAt, updatedAt, dayOfBirth: String?
    let gender: Bool?
    let lastName: String?
    let phone: Int?
    ...
    enum CodingKeys: String, CodingKey {
        case id = "_id"
        case firstName, email, isActive, roleName, createdAt, updatedAt, dayOfBirth, gender, lastName, phone, profileImage
    }
}

enum IsActive: String, Codable {
    case active = "active"
    case banner = "banner"
    case blockposting = "blockposting"
}
